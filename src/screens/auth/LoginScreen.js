  ...
  return (
    <KeyboardAvoidingView style={s.root} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ScrollView contentContainerStyle={s.inner} keyboardShouldPersistTaps="handled">
        ...
        <Text style={s.title}>PortfolioTrack</Text>
        <Text style={s.sub}>Track your investments</Text>
        ...
        <TouchableOpacity style={s.link} onPress={() => navigation.navigate('Signup')}>
          <Text style={s.linkText}>Don't have an account? <Text style={{ color: '#58A6FF' }}>Sign Up</Text></Text>
        </TouchableOpacity>
        <Text style={s.hint}>Demo: any email + any 6-char password</Text>
      </ScrollView>
...
const s = StyleSheet.create({
  ...
  hint: { marginTop: 24, color: '#8B949E', fontSize: 12, textAlign: 'center', fontStyle: 'italic' },
});
